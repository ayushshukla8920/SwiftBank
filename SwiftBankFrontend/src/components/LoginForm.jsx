...
const LoginForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    setLoader(true);
    try {
      const response = await axios.post(`${serverURL}/login`, { username, password }, { withCredentials: true });
  ...
  const handleOTPSubmit = async(event)=>{
    ...
    setLoader(true);
    try {
      const response = await axios.post(`${serverURL}/login/verify-otp`, { username, otp }, { withCredentials: true });
